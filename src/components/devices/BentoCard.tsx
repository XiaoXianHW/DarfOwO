...
export const BentoCard = ({ className = '', children, color = 'from-white/5 to-white/5', delay = 0 }: BentoCardProps) => {
  return (
    <motion.div
      ...
      className={`relative group overflow-hidden rounded-2xl bg-[#1a1a1a] border border-white/5 backdrop-blur-md hover:bg-[#222] transition-all duration-500 ${className}`}
    >
